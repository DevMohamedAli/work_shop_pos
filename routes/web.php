...
Route::prefix('apps')->group(function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::resource('/employees', EmployeeController::class, ['as' => 'apps'])->middleware('permission:employees.index|employees.create|employees.edit|employees.delete');

        // route resource services
        Route::resource('/services', ServiceController::class, ['as' => 'apps'])->middleware('permission:services.index|services.create|services.edit|services.delete');
        ...
        Route::post('/transactions/submit', [TransactionController::class, 'submit'])->name('apps.transactions.submit');
        ...
        Route::post('/transactions/category_products', [TransactionController::class, 'getCategoryProducts']);
