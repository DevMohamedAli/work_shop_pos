<template>
	<Head>
		<title>إنشاء منتج - نظام أبوحصان</title>
	</Head>
	<main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-shopping-bag"></i> إضافة منتج جديد</span>
                            </div>
                            <div class="card-body">
                                ...
                                <form @submit.prevent="submit">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="fw-bold">الباركود</label>
                                                <input class="form-control" v-model="form.barcode" :class="{ 'is-invalid': errors.barcode }" type="text" placeholder="الباركود / كود المنتج">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.title" :class="{ 'is-invalid': errors.title }" type="text" placeholder="اسم المنتج">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="fw-bold">المخزون</label>
                                                <input class="form-control" v-model="form.stock" :class="{ 'is-invalid': errors.stock }" type="number" placeholder="المخزون">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.buy_price" :class="{ 'is-invalid': errors.buy_price }" type="number" placeholder="سعر الشراء">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.sell_price" :class="{ 'is-invalid': errors.sell_price }" type="number" placeholder="سعر البيع">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-start">
                                            <button class="btn btn-primary shadow-sm rounded-sm p-2" type="submit">حفظ</button>
                                            <button class="btn btn-warning shadow-sm rounded-sm ms-3 p-2" type="reset">إعادة تعيين</button>
                                        </div>
                                    </div>
                                </form>
