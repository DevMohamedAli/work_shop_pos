<template>
	<Head>
		<title>إضافة عميل جديد - نظام أبوحصان</title>
	</Head>
	<main class="c-main">
					...
					<div class="col-md-12">
						<div class="card border-0 rounded-3 shadow border-top-purple">
							<div class="card-header">
								<span class="font-weight-bold"><i class="fa fa-user-circle"></i>إضافة عميل جديد</span>
							</div>
							<div class="card-body">
								<form @submit.prevent="submit">
									<div class="row">
										<div class="col-md-6">
											<div class="mb-3">
												<label class="fw-bold">ألاسم بالكامل</label>
										...
										<div class="col-md-6">
											<div class="mb-3">
												...
												<input type="number" v-model="form.no_telp" class="form-control" :class="{ 'is-invalid': errors.no_telp }" placeholder="رقم الهاتف">
											</div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <button class="btn btn-warning shadow-sm rounded-sm ms-3" type="reset">إعادة</button>
                                        </div>
                                    </div>
								</form>
							</div>
