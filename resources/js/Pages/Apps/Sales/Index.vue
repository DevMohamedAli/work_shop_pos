...
<template>
    <Head>
        <title>تقرير المبيعات - نظام أبوحصان</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-chart-bar"></i> تقرير المبيعات</span>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr v-for="sale in sales" :key="sale.id">
                                                ...
                                                <td>{{ sale.customer ? sale.customer.name : 'عام' }}</td>
                                                <td class="text-end">.دل {{ formatPrice(sale.grand_total) }}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="text-end fw-bold" style="background-color: #e6e6e7;">المجموع</td>
                                                <td class="text-end fw-bold" style="background-color: #e6e6e7;">.دل {{ formatPrice(total) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
