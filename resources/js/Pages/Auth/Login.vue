...
<Head>
    <title>تسجيل الدخول - تطبيق الكاشير</title>
</Head>
<div class="col-md-4">
    <div class="fade-in">
        <div class="text-center mb-4">
            <a href="" class="text-dark text-decoration-none">
                ...
                <h3 class="mt-2 font-weight-bold ">تطبيق الكاشير</h3>
            </a>
        </div>
            ...
            <div class="card border-top-purple border-0 shadow-sm rounded-3">
                <div class="card-body">
                    <div class="text-right">
                        <h5>تسجيل الدخول</h5>
                        <p class="text-muted text-right">الرجاء تسجيل الدخول للمتابعة</p>
                    </div>
                    <hr>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary shadow-sm rounded-sm px-4 w-100" type="submit">تسجيل الدخول</button>
                            </div>
                        </div>
                    </form>
                </div>
